...
| 단계 | 폴더 | 하는 일 |
| :---: | :--- | :--- |
| **0** | [0_Data_Collection](0_Data_Collection) | 게임 STT 수집·정제·라벨링 → `train_collected`(518) · `test_set`(688) |
| **1** | [1_Model_Selection](1_Model_Selection) | 6개 모델 벤치마크(test_set 688) → **UnSmile 선정** + 런타임 STT 엔진(Web Speech) 선정 |
...
| **6** | [6_Model_Comparison](6_Model_Comparison) | 8개 모델 test_set(688) 비교 |
...
- **평가**: `test_set`(688, held-out, 학습과 **누수 0**). 1·6·8 모든 평가가 이 파일을 씀.
