...
# Paths (STT 전처리된 데이터 경로)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
# preprocess_stt.py에서 생성한 폴더 및 파일명 지정
TRAIN_FILE = os.path.join(BASE_DIR, 'train_stt', 'unsmile_train_stt.tsv')
VALID_FILE = os.path.join(BASE_DIR, 'train_stt', 'unsmile_valid_stt.tsv')
RESULT_DIR = os.path.join(BASE_DIR, 'results_stt') # 결과도 따로 저장
...
if not os.path.exists(TRAIN_FILE):
    ...
    print("Please run 'python preprocess_stt.py' first to generate the STT-processed dataset.")
    exit(1)

# Load Data
print("Loading STT-processed data...")
...
print("Starting training (STT Processed)...")
