"""
=============================================================================
EchoForest AI - LoRA Fine-tuning (Game-optimized / 게임 환경 최적화)
=============================================================================
게임 음성채팅 환경에 최적화된 LoRA Fine-tuning
...
print("=" * 60)
print("🎮 LoRA Fine-tuning (Game-optimized / KcELECTRA)")
print("=" * 60)
...
with open(f"{OUTPUT_DIR}/results.txt", 'w', encoding='utf-8') as f:
    f.write(f"=== LoRA Game-optimized (KcELECTRA) ===\n")
