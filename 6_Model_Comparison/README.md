...
- **결과**: **Full v2 KcELECTRA 선정**: LRAP 0.936 1위, AP 96.21 1위, 오탐(FP) 23개로 최소, F1 87.78(LoRA v2와 동률)
...
> Recall 1위는 LoRA v2지만 abuse 248문장 중 3문장 차이(통계적 동률)다. 변별은 오탐(FP 23 vs 30)과 임계값-무관 지표(LRAP·AP)에서 나고, 거기서 Full v2가 앞선다. 전체 9개 순위·그래프는 [`results/README.md`](results/README.md).
