...
> 🗂️ **아카이브(옛 결과).** 아래는 구 `game_test`(187건) 기준(2026-02). 현재는 `test_set`(482)·index-8로 **재평가 완료** → 상위 [`../README.md`](../README.md) 참고. 옛 best **Full v2 Tutorial**은 482에선 **4위(80.24%)** 로 밀림(새 best: LoRA v2 Game / Full v2 Game).
