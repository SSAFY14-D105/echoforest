...
> **Q: 왜 Validation에는 수집 데이터를 사용하지 않았나요?**
> 
> **A:** Validation은 **학습 중 과적합 방지 및 체크포인트 선택**을 위한 것이므로, 
> 충분한 양의 UnSmile Valid 데이터(3,663건)를 사용했습니다.
> 수집 데이터(518건)는 양이 적어 Train/Valid/Test로 3분할하면 각각 너무 작아집니다.
> 대신 **최종 성능 평가(Test)**에 수집 데이터를 사용하여 **실제 게임 환경 성능**을 측정합니다.
