...
CREATE TABLE images (
    ...
    -- [추가됨] Soft Delete용 컬럼
                        deleted_at DATETIME NULL COMMENT '삭제 일시 (NULL이면 정상, 값이 있으면 삭제됨)',
...
-- [추가됨] 삭제 여부 조회 성능 향상을 위한 인덱스 (선택 사항)
...
-- 이미지 샘플 (4명이 함께 찍은 사진)
-- file_name 경로 수정 (날짜 폴더 구조 반영)
INSERT INTO images (user_id, file_name, map_id, stage_number, room_code, image_type, deleted_at) VALUES
                                                                                                     (1, '2026-01-21/motion_sample_001.webp', 1, 2, 'ABC123', 'MOTION', NULL),
                                                                                                     (1, '2026-01-21/result_sample_001.webp', 1, NULL, 'ABC123', 'RESULT', NULL);
